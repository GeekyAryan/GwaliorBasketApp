...
const TextBox=({icon,placeHolder,error,password=false,onFocus=()=>{}})=>{
   ...
   <TextInput secureTextEntry={viewPassword?false:true} placeholder={placeHolder} style={{fontSize:18}}/>
   {password?<Icons name={viewPassword?'eye':'eye-off'} style={{fontSize:26,marginLeft:50,}} onPress={handleViewPassword} />:<></>}
    </View>
