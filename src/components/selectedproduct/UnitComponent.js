...
//             return (<View>
//                                <TouchableOpacity onPress={()=>handleSelectedProduct(item)}></TouchableOpacity>
//                 <View style={{ borderWidth: 1, borderColor: Colors.darkGreen, width: width * 0.29, height: height * 0.1, margin: 10, borderRadius: 10, color: 'black', justifyContent: "center", alignItems: 'center', marginVertical: 25 }} >
//                     <View >
