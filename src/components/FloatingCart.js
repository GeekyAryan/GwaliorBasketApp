...
export default function FloatingCart(){
    ...
    return(<View style={{position:'absolute',top:height*0.8,zIndex:1 }}>
          <View style={{margin:10,backgroundColor:Colors.darkGreen,width:width*0.95,height:height*0.08,borderRadius:10,borderWidth:0.4}}>
